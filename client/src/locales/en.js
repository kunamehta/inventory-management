export default {
  ...
  restocking: {
    ...
    description: 'Set your budget and review recommended restocking items based on demand forecasts.',
    ...
    orderSubmitted: 'Order {orderNumber} submitted. Expected delivery: {date}.',
    table: {
      sku: 'SKU',
      itemName: 'Item Name',
